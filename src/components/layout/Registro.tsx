    ...
    <>
      <style>{`
        ...
        @media (max-width: 768px) {
          ...
          .registro-info { display: none; }
        }
      `}</style>
      <section id="registro" style={{ background: 'var(--white)', padding: 'clamp(4rem, 8vw, 7rem) clamp(1.5rem, 5vw, 5rem)' }}>
        <div className="registro-grid">
          ...
          <div style={{ background: 'var(--cream)', borderRadius: '6px', padding: 'clamp(1.5rem, 4vw, 2.5rem)' }}>
            ...
            {tab === 'registro' ? (
              <div>
                ...
                <div style={{ display: 'flex', gap: '1rem', marginBottom: '1rem' }}>
                  {['Nombre', 'Apellido'].map(label => (
                    <div key={label} style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '0.4rem' }}>
                      ...
                      <input type="text" style={{ padding: '0.75rem 1rem', border: '1px solid var(--stone-light)', borderRadius: '3px', background: 'var(--white)', fontFamily: 'var(--font-sans)', fontSize: '0.9rem', color: 'var(--bark)', outline: 'none', width: '100%' }} />
                    </div>
                  ))}
                </div>
                <div style={{ marginBottom: '1rem', display: 'flex', flexDirection: 'column', gap: '0.4rem' }}>
                  ...
                  <input type="email" style={{ padding: '0.75rem 1rem', border: '1px solid var(--stone-light)', borderRadius: '3px', background: 'var(--white)', fontFamily: 'var(--font-sans)', fontSize: '0.9rem', color: 'var(--bark)', outline: 'none', width: '100%' }} />
                </div>
                <div style={{ marginBottom: '1rem', display: 'flex', flexDirection: 'column', gap: '0.4rem' }}>
                  ...
                  <input type="password" style={{ padding: '0.75rem 1rem', border: '1px solid var(--stone-light)', borderRadius: '3px', background: 'var(--white)', fontFamily: 'var(--font-sans)', fontSize: '0.9rem', color: 'var(--bark)', outline: 'none', width: '100%' }} />
                </div>
