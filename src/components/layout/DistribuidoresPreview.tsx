  ...
  return (
    <section style={{ padding: 0 }}>
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', minHeight: '680px' }}>
        <div style={{ padding: '7rem 4rem 7rem 5rem', display: 'flex', flexDirection: 'column', justifyContent: 'center', background: 'var(--cream-dark)' }}>
        ...
        <div style={{ background: 'var(--moss)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '4rem', position: 'relative' }}>
          <div style={{ background: 'var(--white)', borderRadius: '6px', padding: '2.5rem', width: '100%', maxWidth: '380px', boxShadow: '0 20px 60px rgba(0,0,0,0.15)' }}>
