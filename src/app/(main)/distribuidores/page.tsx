...
export default function Distribuidores() {
  ...
  return (
    <>
      <nav style={{ position: 'fixed', top: 0, left: 0, right: 0, zIndex: 100, display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '1.25rem 3rem', background: 'rgba(247,243,236,0.93)', backdropFilter: 'blur(12px)', borderBottom: '1px solid rgba(61,43,26,0.08)' }}>
        <Link href="/" style={{ fontFamily: 'var(--font-serif)', fontSize: '1.5rem', fontWeight: 500, letterSpacing: '0.12em', color: 'var(--bark)', textDecoration: 'none' }}>
      ...
      <section style={{ minHeight: '100vh', background: 'var(--bark)', display: 'flex', alignItems: 'center', padding: '10rem 5rem 7rem' }}>
        <div style={{ maxWidth: '720px' }}>
          ...
          <h1 style={{ fontFamily: 'var(--font-serif)', fontSize: 'clamp(3rem,5vw,5rem)', fontWeight: 300, color: 'var(--cream)', lineHeight: 1.1, marginBottom: '2rem' }}>
            Haz crecer tu<br />negocio con<br /><em style={{ color: 'var(--gold-light)' }}>productos naturales.</em>
          </h1>
          <p style={{ fontSize: '1rem', fontWeight: 300, color: 'var(--stone-light)', lineHeight: 1.8, maxWidth: '480px', marginBottom: '3rem' }}>
      ...
      <section id="programa" style={{ background: 'var(--white)', padding: '7rem 5rem' }}>
        ...
        <h2 style={{ fontFamily: 'var(--font-serif)', fontSize: 'clamp(2.2rem, 3.5vw, 3.8rem)', fontWeight: 300, lineHeight: 1.15, color: 'var(--bark)', marginBottom: '4rem' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: '2rem' }}>
          {[
            ...
            <div key={b.num} style={{ padding: '2.5rem 2rem', background: 'var(--cream)', borderRadius: '4px' }}>
      ...
      <section id="contacto" style={{ background: 'var(--cream-dark)', padding: '7rem 5rem' }}>
        <div style={{ maxWidth: '800px', margin: '0 auto', textAlign: 'center' }}>
          ...
          <h2 style={{ fontFamily: 'var(--font-serif)', fontSize: 'clamp(2.2rem, 3.5vw, 3.8rem)', fontWeight: 300, lineHeight: 1.15, color: 'var(--bark)', marginBottom: '1.5rem' }}>
            Empieza hoy<br />mismo.
          </h2>
          <p style={{ fontSize: '1rem', color: 'var(--stone)', lineHeight: 1.8, maxWidth: '540px', margin: '0 auto 3.5rem' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: '1.5rem', marginBottom: '3rem' }}>
            {[
              ...
              <div key={c.label} style={{ background: 'var(--white)', borderRadius: '5px', padding: '2rem 1.5rem', border: '1px solid var(--cream-dark)' }}>
                ...
                <p style={{ fontFamily: 'var(--font-serif)', fontSize: '1rem', color: 'var(--bark)' }}>{c.value}</p>
              </div>
            ))}
          </div>
          <a href={`https://wa.me/${waNumber}?text=${waMsg}`} target="_blank" rel="noopener noreferrer"
            style={{ display: 'inline-flex', alignItems: 'center', gap: '0.7rem', background: '#25D366', color: 'white', padding: '1rem 2.5rem', borderRadius: '3px', textDecoration: 'none', fontSize: '0.9rem', fontWeight: 500 }}>
          ...
          <p style={{ fontSize: '0.75rem', color: 'var(--stone)', marginTop: '0.8rem' }}>Al escribir, un asistente IA te dará información inmediata sobre el programa.</p>
        </div>
      </section>
    </>
  )
